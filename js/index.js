...
const init = () => {
  ...
  ChatEngine.on('$.ready', function(data) {
      ...
      // create a new ChatEngine Chat
			myChat = new ChatEngine.Chat('chatengine-demo-markdown');
			
      //  Start of user search plugin
      // ----------------------------

			myChat.plugin(ChatEngineCore.plugin['chat-engine-markdown']());
			
			//  End of user search plugin
			// ----------------------------
